...
public class TheGame {
	// In this class random numbers are created and assigned to objects afterwards. User's mobility is implemented here with exceptions for boundaries, blackholes and victory.
	...
	private static HomePlanet homePlanet; //declaring homeplanet for using coordinates
	private static Random random = new Random(); //random method used for creating random numbers, the library is used.
